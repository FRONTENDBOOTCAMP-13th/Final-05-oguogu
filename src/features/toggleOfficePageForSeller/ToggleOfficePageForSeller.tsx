    ...
    <>
      {LoggedInUserType === 'seller' ? (
        <Link
          ...
          /* onClick={handleClick} */
          className="fixed w-20 h-20 bottom-18 right-6 border-3 border-oguogu-main rounded-[100px] bg-oguogu-white/50 shadow-sm shadow-oguogu-gray-2 text-sm flex flex-col items-center justify-center"
          /* style={{
          right: `${position.x}px`,

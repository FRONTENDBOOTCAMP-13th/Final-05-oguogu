...
export default function OrderItem({ orderState }: OrderItemType) {
  let refundState: boolean = false;
  let infoText: string = '결제완료';

  if (orderState === 'paymentCompleted') {
    infoText = '결제 완료';
    refundState = false;
      ...
      <div className="flex flex-col gap-4 justify-between w-[288px] ">
        ...
        <section className="flex justify-between pb-2 ">
          ...
          <div className="w-[216px] h-[48px]">
            ...
            <div className="text-[14px]">쫀득쫀득 대학 미백 찰옥수수 30개입</div>
        ...
        {orderState !== 'purchaseCompleted' &&
          ...
          (refundState ? (
            ...
            <section className="flex justify-center items-center gap-2 text-[12px]">
              ...
              <button className="w-[140px] py-2 leading-none border border-oguogu-main rounded-[4px]">구매 확정</button>
            </section>
          ))}
      </div>
    </>

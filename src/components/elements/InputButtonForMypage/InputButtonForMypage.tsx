...
export function CheckButtonForMypage({ name, type, title, isChecked }: InputButtonForMypageType) {
    ...
    <>
      ...
      <label htmlFor={type} className="text-sm flex items-center gap-1">
        {checkState ? (
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 8.25L7.2 11.75L6 10.3475" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
            <path

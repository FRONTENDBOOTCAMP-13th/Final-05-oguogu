...
export default function PickListItem({ item }: { item: BookmarkItem }) {
  return (
    <div className="flex text-xs gap-2 min-h-20">
      {/* 이미지 */}
      <div className="flex items-center justify-center min-w-[100px] h-[100px] overflow-hidden rounded-sm">
        <Image src="/images/crop/crop-001.png" alt={item.product.name} width={100} height={100} />
      </div>
      {/* 텍스트 */}
      <div className="pl-2 py-1.5 flex flex-col justify-between w-full">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="text-xs w-full px-2 py-0.5 border border-oguogu-gray-2 rounded-sm max-w-[140px] flex items-center justify-center"
          >
            장바구니 추가
          </button>
          <button

    ...
    <>
      <div className="flex text-base gap-2 min-h-20">
        ...
        <Link
          ...
          className="flex items-center justify-center min-w-[100px] h-[100px] overflow-hidden rounded-sm"
        >
          <Image src="/images/crop/crop-001.png" alt={item.product.name} width={100} height={100} />
        </Link>
        {/* 텍스트 */}
        <div className="px-2 py-1.5 flex flex-col justify-between w-full">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              className="text-xs w-full px-2 py-0.5 border border-oguogu-main rounded-sm max-w-[140px] flex items-center justify-center"
            ...
            <button
              type="button"
              className="text-xs w-full px-2 py-0.5 border border-oguogu-gray-2 rounded-sm max-w-[140px] flex items-center justify-center gap-1"

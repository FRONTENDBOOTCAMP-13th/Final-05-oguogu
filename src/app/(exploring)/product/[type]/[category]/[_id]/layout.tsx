  ...
  return (
    <div className="max-w-[320px] min-w-[320px] mx-auto">
      ...
      <nav className="flex min-w-[320px] max-w-[768px]">
        <TextCategoryItem type="product" _id={1} params="detail" title="상품 정보" isClick={true} />
        <TextCategoryItem type="product" _id={1} params="review" title="리뷰(1,280)" isClick={false} />
        <TextCategoryItem type="product" _id={1} params="qna" title="문의(9,999)" isClick={false} />
      </nav>
      {children}
    </div>
  );
